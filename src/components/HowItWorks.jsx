...
const StepCard = ({ item, index }) => (
    <motion.div
        ...
        style={{
            background: '#FFFFFF',
            border: '1.5px solid #F1F5F9', // Subtle border
    ...
    >
        ...
        <div style={{
            ...
            background: `${item.color}08`, // Very light background
        ...
        <section id="how-it-works" style={{
            ...
            <div style={{ maxWidth: 1120, margin: '0 auto', position: 'relative', zIndex: 2 }}>
                ...
                >
                    ...
                    <p style={{ color: '#64748B', maxWidth: 460, margin: '0 auto', fontSize: '1rem', lineHeight: 1.6, fontWeight: 500 }}>
